...
namespace HTML::Tokenizer {
	std::map<ParserState, ParserStateInfo> parserStateNames = {
		...
		{ ParserState::AFTER_ATTRIBUTE_VALUE_QUOTED,
		...
		{ ParserState::MARKUP_DECLARATION_OPEN,
		...
		{ ParserState::COMMENT_LTS_BANG_DASH,
			{ "COMMENT_LTS_BANG_DASH", "12.2.5.48 Comment less-than sign bang dash state" } },
		{ ParserState::COMMENT_LTS_BANG_DASH_DASH,
		...
		{ ParserState::NAMED_CHARACTER_REFERENCE,
