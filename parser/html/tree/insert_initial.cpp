...
const std::vector<const char *> quirkyPublicIdentifiers = {"-//W3O//DTD W3 HTML Strict 3.0//EN//",
	"-/W3C/DTD HTML 4.0 Transitional/EN", "HTML", "+//Silmaril//dtd html Pro v0r11 19970101//",
	...
	"-//IETF//DTD HTML 2.1E//", "-//IETF//DTD HTML 3.0//", "-//IETF//DTD HTML 3.2 Final//", "-//IETF//DTD HTML 3.2//",
...
HTML::InsertionModes::Initial::CheckDoctypeParserErrors(HTML::Tokenizer::DoctypeToken *token) const noexcept {
	...
	if (token->systemIdentifier.has_value()
		...
		context.parserContext.ReportParserError("InitialInsertionMode",
