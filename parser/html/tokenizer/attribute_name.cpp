...
HTML::Tokenizer::AttributeName::Parse() {
	...
	const static std::array<char, 6> characterList = { Unicode::CHARACTER_TABULATION, Unicode::LINE_FEED, Unicode::FORM_FEED, Unicode::SPACE, '\\', Unicode::GREATER_THAN_SIGN };
	...
	} else if (context.character >= Unicode::LATIN_CAPITAL_LETTER_A && context.character <= Unicode::LATIN_CAPITAL_LETTER_Z) { // Is uppercase
