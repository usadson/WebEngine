# WebEngine
| Travis CI | Github Actions | Code Quality | License
|-|-|-|-
| [![Build Status](https://travis-ci.com/usadson/WebEngine.svg?branch=master)](https://travis-ci.com/usadson/WebEngine) | ![C/C++ CI](https://github.com/usadson/WebEngine/workflows/C/C++%20CI/badge.svg) | [![BCH compliance](https://bettercodehub.com/edge/badge/usadson/WebEngine?branch=master)](https://bettercodehub.com/) | [![License](https://img.shields.io/badge/License-BSD%202--Clause-orange.svg)](https://opensource.org/licenses/BSD-2-Clause)
